...
async function getData() {
  ...
  //  const response = await fetch(`https://ipinfo.io/103.39.129.236/geo`)
    const response = await fetch(`https://ipinfo.io/103.39.129.236?token=302360f2adb0ee`)
    ...
    const postal = await fetch(`https://api.postalpincode.in/pincode/382421`)
